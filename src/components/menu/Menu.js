						...
						<ul id='menu'>
							<li>
								<Link to='/'>
									...
									<label htmlFor='menuCheckbox'>{language === "en" ? "Tasks" : "Задачи"}</label>
								</Link>
							</li>
							<li>
								<Link to='/completed'>
									...
									<label htmlFor='menuCheckbox'>{language === "en" ? "Completed" : "Выполнено"}</label>
								</Link>
							</li>
							<li>
								<Link to='/filter'>
									...
									<label htmlFor='menuCheckbox'>{language === "en" ? "Filter" : "Фильтрация"}</label>
								</Link>
							</li>
							<li>
								<Link to='/labels'>
									...
									<label htmlFor='menuCheckbox'>{language === "en" ? "Labels" : "Метки"}</label>
								</Link>
							</li>
							<li>
								<div
									...
									<Link onClick={this.toggleOpenLanguage}>
										...
										<label htmlFor='menuCheckbox'>{language === "en" ? "Language" : "Язык"}</label>
									</Link>
									<div className='languages__items'>
										<div
											...
											<span>{language === "en" ? "English" : "Английский"}</span>
										</div>
										<div
											...
											<span>{language === "en" ? "Russain" : "Русский"}</span>
										</div>
									</div>
								</div>
							</li>
